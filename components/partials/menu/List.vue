...
<template>
  <li>
    <a
      ...
      <span
        class="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-gray-800 bg-gray-100 rounded-full dark:bg-gray-600 dark:text-gray-300">
        {{ badge }}</span>
    </a>
  </li>
</template>
