...
<template>
  <div class="flex pb-5">
    ...
    <div
      class="w-full sm:w-1/2 lg:w-2/3 flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
      <button v-if="new_url" @click="router.push(new_url)" type="button"
      ...
      <div class="flex items-center space-x-3 w-full md:w-auto">
        <button v-if="false" id="actionsDropdownButton" data-dropdown-toggle="actionsDropdown"
        ...
        <button v-if="false" id="filterDropdownButton" data-dropdown-toggle="filterDropdown"
          class="w-full md:w-auto flex items-center justify-center py-2 px-4 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
          type="button">
